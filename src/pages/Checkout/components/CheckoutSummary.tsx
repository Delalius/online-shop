  ...
  return (
    <section className="rounded-[2rem] border border-slate-900 bg-slate-950 p-6 text-white shadow-[0_20px_80px_-45px_rgba(15,23,42,0.65)]">
      ...
      <button
        ...
        className="mt-6 w-full rounded-2xl bg-amber-700 px-5 py-4 text-base font-semibold text-white transition hover:bg-amber-800 disabled:cursor-not-allowed disabled:bg-slate-400"
      >
        Confirm order
      </button>
    </section>
